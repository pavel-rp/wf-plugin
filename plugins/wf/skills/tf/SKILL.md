...
- **Registered-but-unrecoverable delivery or tracker:** the write surfaces the hedged candidate-naming diagnosis (delivery once at Phase 3, tracker once at Phase 4), never asserting a pack owns the surface; the local finalize completes.
