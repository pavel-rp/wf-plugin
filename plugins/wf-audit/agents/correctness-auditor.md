...
3. Read `${CLAUDE_PLUGIN_ROOT}/capabilities/audit/fragments/correctness.md` — your rubric;
...
5. Emit **only** the contract's finding block, tagged `lens: correctness`, as the very
