...
- <!-- capability-route:audit-distill-review --> **`pr-comments-read`** — route one `MODE: review` distiller Task over the source-id-tagged body batch; fold its compact `REVIEW DISTILL` verdicts in.
