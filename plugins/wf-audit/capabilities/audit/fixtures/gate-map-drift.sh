...
#
# Usage:  bash plugins/wf-audit/capabilities/audit/fixtures/gate-map-drift.sh
...
# Drift cases: the lens finding contract, sr's own grammar, and the retrospective verdict.
drift audit-lens audit/fragments/finding-contract.md \
  '- severity: <fail | warn>' '- severity: <fail | warn | info>' info \
  audit/gate-maps/correctness.gate-map.md
drift sr sr/fragments/self-review.md \
  '- severity: <fail | warn>' '- severity: <fail | warn | info>' info \
  sr/gate-maps/sr.gate-map.md
drift audit-retrospective audit/fragments/retrospective.md \
  '<PASS | PASS WITH WARNINGS | FAIL>' '<PASS | PASS WITH WARNINGS | FAIL | INCONCLUSIVE>' INCONCLUSIVE \
  audit/gate-maps/audit-retrospective.gate-map.md
