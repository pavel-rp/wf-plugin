...
Fixture report, first follow-up: nothing new confirmed; every prior draw is suppressed as a
duplicate, and one draw from a new source for H2 is kept distinct.
