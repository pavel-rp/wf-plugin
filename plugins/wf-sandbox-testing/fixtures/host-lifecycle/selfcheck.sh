...
grep -Fxq '**Host availability:** unavailable' "$QA_GEN" || fail "api host-unavailable exact marker missing"
...
grep -Fxq '**Host availability:** unavailable' "$QA_TEMPLATE" || fail "browser host-unavailable exact marker missing"
