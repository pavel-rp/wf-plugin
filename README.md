...
Internal Claude Code marketplace for the VMG team. Currently hosts one plugin:
...
(Replace `pavel-rp/vmg-workflow-claude` with the repo's actual `owner/name` once pushed, or use a local path / full git URL.)
